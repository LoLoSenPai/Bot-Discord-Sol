...
//       // Fonction qui permet de changer le texte
//       function changeCommande(commande) {
//         if (!space) {
//           let collec = collec.split(" ").join("");
//           space = true;
//           return collec;
//         } else if (!underscore) {
//           let collec = collec.split(" ").join("_");
//           underscore = true;
//           return collec;
//         }
//       }

//       // fonction qui permet de faire l'appel a l'api
//       async function callApi(commande) {
...
//         const response = "https://api.howrare.is/v0.1/collections/" + commande;
//         return response;
//       }

//       // boucle qui va faire les tests et se terminera une fois la bonne reponse de l'api
//       while (callApi(response).code_api != 200) {
//         let collec = changeCommande(collec);
//       }
...
//         content:
//           "Your collection doesn't exist or try replacing spaces with underscores",
//       });
//     }
//   },
// };
...
module.exports = {
	data: new SlashCommandBuilder()
		.setName('bim')
		.setDescription('Replies with Bam!'),
	async execute(interaction) {
		await interaction.reply({ content: 'Bam!', ephemeral: true });
	},
};